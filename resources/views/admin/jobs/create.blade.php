                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.jobs.store') }}">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <textarea class="form-control @error('qualification') is-invalid @enderror" id="qualification" name="qualification" rows="3" required>{{ old('qualification') }}</textarea>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="number" class="form-control @error('no_of_openings') is-invalid @enderror" id="no_of_openings" name="no_of_openings" value="{{ old('no_of_openings') }}" required>
                            ...
                            <button type="submit" class="btn btn-primary mt-2">Create Job</button>
                        </form>
                    </div>
                </div>
            </div>
